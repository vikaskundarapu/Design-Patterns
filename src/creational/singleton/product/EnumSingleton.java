...
/**
 * Enum Singleton: to overcome this situation with Reflection, Joshua Bloch
 * suggests the use of Enum to implement Singleton design pattern as Java
...
public enum EnumSingleton {
	...
	public static void doSomething() {
		System.out.println("Best singleton implementation as Joshua Bloch");
	}
}
