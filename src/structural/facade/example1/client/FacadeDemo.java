package structural.facade.example1.client;

import structural.facade.example1.FacadeShapeMarker;
 ...
 * under structural pattern as this pattern adds an interface to existing system to hide its complexities.
